...
enum WeatherCode: Int {
    ...
    var description: String {
        ...
        case .rainSlight, .rainModerate, .rainHeavy, .rainShowersSlight, .rainShowersModerate,
            .rainShowersViolent:
            return "Rainy"
        case .snowFallSlight, .snowFallModerate, .snowFallHeavy, .snowGrains, .snowShowersSlight,
            .snowShowersHeavy:
            return "Snowy"
